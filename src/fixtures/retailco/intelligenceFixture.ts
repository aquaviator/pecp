...
export const RETAILCO_INTELLIGENCE_ITEMS_FIXTURE: IntelligenceItem[] = [
  {
    ...
    state: 'CONFLICTING',
    unit: 'orders/hour',
    value: '31,500 (Candidate)', // Display value note; candidates shown in detail
    ...
    history: [
      ...
      { date: '2026-08-15T11:21:00Z', action: 'Classified state as CONFLICTING', actor: 'Deterministic Model Validator' }
    ]
  },
  {
